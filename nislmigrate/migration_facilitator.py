...
class MigrationFacilitator:
    ...
    def __report_migration_starting(self, migrator_name: str, action: MigrationAction, migration_directory: str):
        actionPrettyName = "capture" if action == MigrationAction.CAPTURE else "restore"
        print("Starting to {0} data using {1} migrator strategy ...".format(actionPrettyName, migrator_name))
