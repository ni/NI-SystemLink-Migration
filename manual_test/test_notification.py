...
class TestNotification(ManualTestBase):
    ...
    def __assertAddressGroupsEqual(self, expected: Dict[str, Any], actual: Dict[str, Any], exact: bool):
        if exact:
    ...
    def __assertMessageTemplatesEqual(self, expected: Dict[str, Any], actual: Dict[str, Any], exact: bool):
        if exact:
            assert expected == actual
        else:
            assert expected['interpretingServiceName'] == actual['interpretingServiceName']
    ...
    def __assertNotificationStrategiesEqual(self, expected: Dict[str, Any], actual: Dict[str, Any], exact: bool):
        if exact:
            assert expected == actual
        else:
            assert expected['displayName'] == actual['displayName']
